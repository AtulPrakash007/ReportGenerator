//
//  ReportGeneratorforSelectedRegressionAndCodeCoverage_New.swift
//  SwiftReportGenerator
//
//  Created by Atul Prakash on 10/03/20.
...
class ReportGenerator
{
    var filePath = ""
    var htmlFilePath = ""
    var userInput = CommandLine.arguments[9]
    var noOfClasses = CommandLine.arguments[10]
